# Networking basics
Project done during **Full Stack Software Engineering studies** at **ALX AFRICA**. The aim is to learn about the basics of Networking i.e `OSI model, LAN, WAN, IP address, localhost, subnet and TCP/UDP`.
